var Name_Of_The_Guest_Array = []; function Submit() {

	var Guest_name = document.getElementById("Enter_name").value; Name_Of_The_Guest_Array.push(Guest_name);
	
	console.log(Name_Of_The_Guest_Array);
	
	document.getElementById("Display_names").innerHTML = Name_Of_The_Guest_Array; console.log(length_of_the_array);
	...
	var i = Name_Of_The_Guest_Array.join("<br>"); console.log(Name_Of_The_Guest_Array);
